...
const DashBoardPage = () => {
    return (
        <div className="relative bg-yellow-50 overflow-hidden max-h-screen">
                    ...
                    <div className="flex-grow">
                        ...
                        <div className="p-4">
                            <ul className="space-y-1">
                                <li>
                                    <Link href="" className="flex items-center bg-yellow-200 rounded-xl font-bold text-sm text-yellow-900 py-3 px-4">
            ...
            <main className="max-h-screen mt-14 overflow-auto">
