                    ...
                    <div className="mt-12 flex flex-col items-center">
                        ...
                        <div className="w-full flex-1 mt-8">
                            ...
                            <div className="mx-auto max-w-xs">
                                ...
                                <button className="mt-4 tracking-wide font-semibold bg-indigo-500 text-gray-100 w-full px-4 py-2 rounded-lg hover:bg-indigo-700 transition-all duration-300 ease-in-out flex items-center justify-center focus:shadow-outline focus:outline-none"
                                    onClick={() => onSubmit()}
                                >
                                ...
                                <p className="mt-2 text-xs text-gray-600 text-center">
                                    ...
                                    <Link href="/auth/register" className="border-b border-gray-500 border-dotted">
                                        Register
                                    </Link>
                                </p>
                            </div>
